...
def test2():
    ...
    check50.run("python3 dna.py databases/small.csv sequences/2.txt").stdout("No match\n").stdout(check50.EOF).exit(0)

@check50.check(exists)
def test3():
    """correctly identifies sequences/3.txt"""
    check50.run("python3 dna.py databases/small.csv sequences/3.txt").stdout("No match\n").stdout(check50.EOF).exit(0)
...
def test13():
    ...
    check50.run("python3 dna.py databases/large.csv sequences/13.txt").stdout("No match\n").stdout(check50.EOF).exit(0)
...
def test16():
    ...
    check50.run("python3 dna.py databases/large.csv sequences/16.txt").stdout("No match\n").stdout(check50.EOF).exit(0)
...
def test18():
    ...
    check50.run("python3 dna.py databases/large.csv sequences/18.txt").stdout("No match\n").stdout(check50.EOF).exit(0)
...
def test20():
    ...
    check50.run("python3 dna.py databases/large.csv sequences/20.txt").stdout("No match\n").stdout(check50.EOF).exit(0)
