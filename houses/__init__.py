...
def import1():
    ...
    check50.run("python3 import.py students.csv").exit(0)
...
def roster_hufflepuff():
    ...
    actual = check50.run("python3 roster.py Hufflepuff").stdout()
...
def roster_gryffindor():
    ...
    actual = check50.run("python3 roster.py Gryffindor").stdout()
