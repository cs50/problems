...
def import1():
    ...
    check50.run("python3 import.py students.csv", timeout=10).exit()
...
def roster_hufflepuff():
    ...
    actual = check50.run("python3 roster.py Hufflepuff", timeout=10).stdout()
...
def roster_gryffindor():
    ...
    actual = check50.run("python3 roster.py Gryffindor", timeout=10).stdout()
